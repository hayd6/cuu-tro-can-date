...
export default function CheckoutClient({
  ...
  return (
    <div className="bg-surface text-on-surface min-h-[100dvh] font-body relative pb-32 overflow-y-auto">
      {/* Top AppBar */}
        ...
        <section className="bg-surface-container-lowest rounded-2xl p-5 border border-outline-variant/10 shadow-sm">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-grow space-y-1">
              <h2 className="text-on-surface font-bold text-lg leading-tight">{product.store.name}</h2>
              ...
              <div className="flex flex-wrap items-center gap-2 mt-3 bg-primary/5 py-1.5 px-3 rounded-full w-fit">
                ...
                <span className="text-primary font-semibold text-xs uppercase tracking-wider">Lấy hàng trong giờ mở cửa</span>
              </div>
            </div>
          </div>
        ...
        <section className="bg-surface-container-lowest rounded-2xl p-5 space-y-4 border border-outline-variant/10 shadow-sm">
          ...
          <div className="flex items-center justify-between group gap-4">
            <div className="flex flex-col">
              <span className="text-on-surface font-semibold text-base mb-1">{product.name}</span>
              <span className="text-primary font-bold">{(product.discountPrice * quantity).toLocaleString("vi-VN")}đ</span>
            </div>
