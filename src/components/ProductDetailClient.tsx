  ...
  return (
    <div className="bg-surface text-on-surface min-h-[100dvh]">
      ...
      <main className="pb-32">
        {/* Visual Area */}
        <section className="relative aspect-[16/9] w-full overflow-hidden bg-surface-container-highest">
          <img
            alt={product.name}
        ...
        <div className="px-5 -mt-6 relative z-10">
          <div className="bg-surface-container-lowest rounded-3xl p-6 shadow-[0_12px_32px_-4px_rgba(20,27,43,0.04)]">
            {/* Title & Price */}
      ...
      {/* Bottom Action Bar */}
      <nav className="fixed bottom-0 left-0 w-full z-50 bg-white shadow-[0_-8px_24px_-4px_rgba(20,27,43,0.06)] px-5 py-3 pb-6 flex items-center gap-3">
        {/* Quantity Selector */}
